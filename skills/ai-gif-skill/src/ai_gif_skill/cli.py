...
def build_parser() -> argparse.ArgumentParser:
    ...
    generate_parser.add_argument("--cols", type=int, default=DEFAULT_COLS)
    ...
    gif_parser.add_argument("--rows", type=int, default=DEFAULT_ROWS)
    gif_parser.add_argument("--cols", type=int, default=DEFAULT_COLS)
